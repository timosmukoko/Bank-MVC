...
<BODY>
    ...
    <br>
    <input type="text" name="last" value="${badCustomer.firstName}"/><br>
<input type="text" name="last" value="${badCustomer.lastName}"/><br>
<input type="text" name="last" value="${badCustomer.sortCode}"/><br>
<input type="text" name="last" value="${badCustomer.balance}"/><br>
