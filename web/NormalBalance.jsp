...
<BODY>
    ...
    <input type="text" name="last" value="${regularCustomer.firstName}"/><br>
    <input type="text" name="last" value="${regularCustomer.lastName}"/><br>
<input type="text" name="last" value="${regularCustomer.sortCode}"/><br>
<input type="text" name="last" value="${regularCustomer.balance}"/><br>
</BODY>
</HTML>